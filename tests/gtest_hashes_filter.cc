...
TEST(HashesFilterTest, FilterTest) {
  ...
  filter_result = hashes_meta_filter->Filter(0,
          "FILTER_TEST_KEY", tmf_meta_value1.Encode(), &new_value, &value_changed);
  ...
  std::this_thread::sleep_for(std::chrono::milliseconds(1000));
  filter_result = hashes_meta_filter->Filter(0,
          "FILTER_TEST_KEY", tmf_meta_value2.Encode(), &new_value, &value_changed);
  ...
  filter_result = hashes_meta_filter->Filter(0,
          "FILTER_TEST_KEY", tmf_meta_value3.Encode(), &new_value, &value_changed);
  ASSERT_EQ(filter_result, false);
  ...
  filter_result = hashes_meta_filter->Filter(0,
          "FILTER_TEST_KEY", tmf_meta_value4.Encode(), &new_value, &value_changed);
  ASSERT_EQ(filter_result, true);
  ...
  HashesDataFilter* hashes_data_filter1 = new HashesDataFilter(meta_db, &handles);
  ...
  s = meta_db->Put(rocksdb::WriteOptions(), handles[0], "FILTER_TEST_KEY", tdf_meta_value1.Encode());
  ASSERT_TRUE(s.ok());
  HashesDataKey tdf_data_key1("FILTER_TEST_KEY", version, "FILTER_TEST_FIELD");
  filter_result = hashes_data_filter1->Filter(0,
          tdf_data_key1.Encode(), "FILTER_TEST_VALUE", &new_value, &value_changed);
  ASSERT_EQ(filter_result, false);
  s = meta_db->SingleDelete(rocksdb::WriteOptions(), handles[0], "FILTER_TEST_KEY");
  ASSERT_TRUE(s.ok());
  delete hashes_data_filter1;

  // timeout timestamp is set, but not timeout
  HashesDataFilter* hashes_data_filter2 = new HashesDataFilter(meta_db, &handles);
  ...
  s = meta_db->Put(rocksdb::WriteOptions(), handles[0], "FILTER_TEST_KEY", tdf_meta_value2.Encode());
  ASSERT_TRUE(s.ok());
  HashesDataKey tdf_data_key2("FILTER_TEST_KEY", version, "FILTER_TEST_FIELD");
  filter_result = hashes_data_filter2->Filter(0,
          tdf_data_key2.Encode(), "FILTER_TEST_VALUE", &new_value, &value_changed);
  ASSERT_EQ(filter_result, false);
  s = meta_db->SingleDelete(rocksdb::WriteOptions(), handles[0], "FILTER_TEST_KEY");
  ASSERT_TRUE(s.ok());
  ...
  // timeout timestamp is set, already timeout
  HashesDataFilter* hashes_data_filter3 = new HashesDataFilter(meta_db, &handles);
  ...
  s = meta_db->Put(rocksdb::WriteOptions(), handles[0], "FILTER_TEST_KEY", tdf_meta_value3.Encode());
  ASSERT_TRUE(s.ok());
  std::this_thread::sleep_for(std::chrono::milliseconds(2000));
  HashesDataKey tdf_data_key3("FILTER_TEST_KEY", version, "FILTER_TEST_FIELD");
  filter_result = hashes_data_filter3->Filter(0,
          tdf_data_key3.Encode(), "FILTER_TEST_VALUE", &new_value, &value_changed);
  ASSERT_EQ(filter_result, true);
  s = meta_db->SingleDelete(rocksdb::WriteOptions(), handles[0], "FILTER_TEST_KEY");
  ASSERT_TRUE(s.ok());
  ...
  HashesDataFilter* hashes_data_filter4 = new HashesDataFilter(meta_db, &handles);
  ...
  s = meta_db->Put(rocksdb::WriteOptions(), handles[0], "FILTER_TEST_KEY", tdf_meta_value4.Encode());
  ASSERT_TRUE(s.ok());
  HashesDataKey tdf_data_key4("FILTER_TEST_KEY", version, "FILTER_TEST_FIELD");
  version = tdf_meta_value4.UpdateVersion();
  s = meta_db->Put(rocksdb::WriteOptions(), handles[0], "FILTER_TEST_KEY", tdf_meta_value4.Encode());
  ASSERT_TRUE(s.ok());
  filter_result = hashes_data_filter4->Filter(0,
          tdf_data_key4.Encode(), "FILTER_TEST_VALUE", &new_value, &value_changed);
  ASSERT_EQ(filter_result, true);
  s = meta_db->SingleDelete(rocksdb::WriteOptions(), handles[0], "FILTER_TEST_KEY");
  ASSERT_TRUE(s.ok());
  ...
  HashesDataFilter* hashes_data_filter5 = new HashesDataFilter(meta_db, &handles);
  ...
  s = meta_db->Put(rocksdb::WriteOptions(), handles[0], "FILTER_TEST_KEY", tdf_meta_value5.Encode());
  ASSERT_TRUE(s.ok());
  HashesDataKey tdf_data_key5("FILTER_TEST_KEY", version, "FILTER_TEST_FIELD");
  s = meta_db->SingleDelete(rocksdb::WriteOptions(), handles[0], "FILTER_TEST_KEY");
  ASSERT_TRUE(s.ok());
  filter_result = hashes_data_filter5->Filter(0,
          tdf_data_key5.Encode(), "FILTER_TEST_VALUE", &new_value, &value_changed);
  ASSERT_EQ(filter_result, true);
